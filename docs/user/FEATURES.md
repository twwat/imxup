...
**Description:** Upload galleries to 6 premium file hosting services simultaneously.
...
|-------------|-------------|----------|
| `#custom1-4#` | User-defined fields | Photographer, camera, location, license |
| `#ext1-4#` | External app outputs | Upload links, processing results, ratings |
...
**Version:** v0.6.00
**Description:** Comprehensive integration with 6 file hosting services.
...
**User Documentation:**
- [GUI Guide](user/gui-guide.md) - Complete GUI walkthrough
- [Multi-Host Upload](user/multi-host-upload.md) - File host setup
- [BBCode Templates](user/bbcode-templates.md) - Template reference
- [Keyboard Shortcuts](user/keyboard-shortcuts.md) - All shortcuts
- [Quick Start](user/quick-start.md) - 5-minute guide
